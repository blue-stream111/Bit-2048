...
template <> constexpr inline auto start::qt_create_metaobjectdata<qt_meta_tag_ZN5startE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Slot 'on_pushHelp_clicked'
        QtMocHelpers::SlotData<void()>(4, 2, QMC::AccessPublic, QMetaType::Void),
        // Slot 'on_pushLeave_clicked'
...
void start::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->on_pushHelp_clicked(); break;
        case 3: _t->on_pushLeave_clicked(); break;
        case 4: _t->getBack(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (start::*)()>(_a, &start::startGame, 0))
            return;
    }
}
